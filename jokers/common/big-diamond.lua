local jokerName = "big_diamond" -- CHANGE THISSSSSSSSSSSSSSSSS
...
local jokerThing = SMODS.Joker{
    ...
    update = function(self, card, dt)
      G.P_CENTERS.j_threex_big_diamond.pos.x = 3 + (G.SETTINGS.colourblind_option and 1 or 0)
    end,
